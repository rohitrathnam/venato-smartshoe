...
% Direct integration of the signal using Cavalieri-Simpons' method 
% through the function SINTEGRATE
...
% The integrating signal must have the last of the original signal as its first sample, and so on
...
%% Media pesata rispetto a w
% dri(t) is the weighted sum with respect to w (t) of d (t) and r (t)
driSignal = ri.*w'+di.*(1-w)';

%   REFERENCES:
%   [1] Zok, M., Mazzà, C., & Della Croce, U. (2004). Total body centre of
%       mass displacement estimated using ground reactions during
%       transitory motor tasks: application to step ascent.
%       Medical Engineering & Physics, 26(9), 791–798. Elsevier.
