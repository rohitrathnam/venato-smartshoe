...
#define LSM9DS1_ADDRESS_0          0x6b
#define LSM9DS1_ADDRESS_1          0x6a
...
int LSM9DS1Class::begin(bool is_ext_imu)
{
  _wire->begin();
  if (is_ext_imu) {
    LSM9DS1_ADDRESS = LSM9DS1_ADDRESS_1;
  }
  else {
    LSM9DS1_ADDRESS = LSM9DS1_ADDRESS_0;
  }
...
int LSM9DS1Class::accelerationAvailable()
{
  if (continuousMode) {
    ...
    return (readRegister(LSM9DS1_ADDRESS, 0x2F) & 0x3F);
  } else {
...
void LSM9DS1Class::setSampleRate119Hz()
{
  if(continuousMode) {
    writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x78); // set gyro to 119Hz
    writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL, 0x78); // set acc to 119Hz
  }
}
