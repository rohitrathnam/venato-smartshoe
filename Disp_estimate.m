function [Displ Vel SP Acc]= Disp_estimate(HS,TO,Agfree,gyr,fs)
...
radius=0.07; % distance between imu and malleolus center
...
% MEAN_VALUE_REMOVAL: helpful to reduce noise, drift etc 
